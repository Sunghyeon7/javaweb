...
<head>
  ...
  <script>
    ...
    // 상품 등록 전 기본적인 사항 체크 후 정상적인 값을 서버로 전송한다.
    function fCheck(){
        ...
        <td colspan="4" class="text-center">
          <table class="table">
            <tr>
              ...
              <td><input type="number" name="price" id="price0" value="590000" /></td>
              <td><input type="number" name="su" id="su0" value="0" style="width:60px" /></td>
              <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </td>
            </tr>
          </table>
          <div id="demo"></div>
