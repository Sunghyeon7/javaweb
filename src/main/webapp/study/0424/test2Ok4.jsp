...
<jsp:useBean id="vo" class="study.t0424.Test1VO"></jsp:useBean>

<!-- jsp 에서는  getPropoerty와 setProperty을 이용해서 값을 불러오거나 저장시켜 준다. -->
<!-- 서블릿에서는  getter()와 setter()을 이용해서 값을 불러오거나 저장시켜 준다. -->
