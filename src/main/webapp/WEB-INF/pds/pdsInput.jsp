...
<div class="container">
	<form name="myform" method="post" action="${ctp}/PdsInputOk.pds" enctype="multipart/form-data">
		<h2 class="test-center"> 자료 올리기 </h2>
		<br/>
		<div>
			<input type="button" value="첨부파일 추가" onclick="fileBoxAppend()" class="btn btn-info btn-sm " />
		...
		<div class="mb-2">
			내용 : <textarea rows="4" name="content" id="content" placeholder="상세 내용을 입력해 주세요" class="form-control" /></textarea>
		</div>
		<div class="mb-2">
			분류 : 
		...
		<div class="mb-2">
			비밀번호 : 
			<input type="password" name="pwd" id="pwd" placeholder="비밀번호를 입력해주세요." required />
		</div>
		<div class="mb-2 text-center">
			<input type="button" value="자료 올리기" onclick="fCheck()" class="btn btn-primary" /> &nbsp;
			<input type="button" value="다시 작성" class="btn btn-warning" /> &nbsp;
