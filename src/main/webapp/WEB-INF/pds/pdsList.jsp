    ...
    <c:forEach var="vo" items="${vos}" varStatus="st">
      <tr>
        ...
        <td>
          ...
          <!-- <button type="button" class="badge badge-danger border-0" data-toggle="modal" data-target="#myModal">삭제(모달)</button> -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">자료실 데이터 삭제(모달)</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>

      <!-- Modal body -->
      <div class="modal-body">
        <input type="password" name="pwd" id="pwd" placeholder="비밀번호를 입력해주세요." autofocus class="form-control">
      </div>

      <!-- Modal footer -->
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" onclick="pdsDeleteCheck2()">Check</button>
